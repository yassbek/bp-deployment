...
export default function CompletionPage() {
    ...
    const applicationSteps = [
        ...
        { title: "Wachstum & Vertrieb", icon: Briefcase, status: "next", path: `/preparation_distribution?applicationId=${applicationId}` }
    ]
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="text-center mb-12">
                    ...
                    <p className={`text-gray-600 mt-2 max-w-2xl mx-auto transition-opacity duration-700 delay-200 ${showSuccess ? "opacity-100" : "opacity-0"}`}>
                        Hervorragend, nur noch ein Schritt bis zum Abschluss der Interviews. Jetzt kommt das letzte Thema.
                    </p>
                </div>
